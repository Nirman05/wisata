<div class="row">
  <div class="col-lg-12">
    <h1>Daftar Wisata <small>Pantai Buol</small></h1>
    <ol class="breadcrumb">
...
<div class="row">
  <div class="col-sm-12">
    <div class="table-responsive" >
      ...
      <table class="table table-hover table-striped table-bordered table-sm">
        ...
        if ($_SESSION['level'] == 'admin') {
          $sql = mysqli_query($config, "SELECT * FROM pantai");
        } else {
          $sql = mysqli_query($config, "SELECT * FROM pantai WHERE id_user = '$_SESSION[id_user]'");
        }
    ...
    <tr>
            ...
            <td>
              <div align="center"><?php echo $data['nm_pantai']; ?></div>
            </td>
            <td>
            ...
            <td>
              <div align="justify" style="height:  200px; overflow: scroll;"><?php echo $data['inf_pantai']; ?></div>
            </td>
            <td>
              <div align="center">
            ...
            <td>
              <div align="center">
                <a class="btn btn-info btn-xs" href="models/edit_pantai.php?id=<?php echo $data['id_pantai']; ?>">Edit</a>
              </div>
            </td>
            <td>
              <div align="center">
                <a class="btn btn-danger btn-xs" href="helper/proses_delet.php?id=<?php echo $data['id_pantai']; ?>"  onclick="return confirm('Hapus data?')" class="alert alert-danger" role="alert">Hapus</a> 
              </div>
            </td>
        </tr>
        <?php
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="" method="post" enctype="multipart/form-data">
        <div class="modal-body">
          <div class="form-group">
            <label class="control-label" for="nm_pantai">Nama Lokasi</label>
            <input type="text" name="nm_pantai" class="form-control" id="nm_pantai" required>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="box-body pad">
              <textarea id="inf_pantai" name="inf_pantai" class="form_control" type="text" rows="4" cols="77" required></textarea>
            </div>
          </div>
          <div class="form-group">
      ...
      if (isset($_POST['tambah'])) {
        ...
        if ($upload) {
          mysqli_query($config, "INSERT INTO pantai VALUES ('','$nm_pantai','$gr_lintang','$gr_bujur','$inf_pantai','$gambar','$id')");
          header("location: ?page=wisata_pantai");
        } else {
