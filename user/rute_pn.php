  ...
  <div class="card mb-3" style="max-width: 100%;">
      <div class="row no-gutters">
        ...
        <?php
            ...
            if(isset($_GET['id'])){
            $id =$_GET['id'];
            $query = mysqli_query($config, "SELECT * FROM penginapan WHERE id_penginapan ='$id'");
            $d = mysqli_fetch_array($query);
           }
          ?>
          <div id="destinationHolder">
            <input type="text" id="destination_input" value="<?php echo $d['lintang']; echo ","; echo $d['bujur']; ?>" onClick="this.select();" />
