<div id="wisata_alam"><?php
 ...
 <div class="container">
        ...
        <?php
        //ambil data
        $get = $config->query("SELECT c.id_lokasi AS id_lokasi, nm_lokasi, informasi, AVG(rating) AS rating, gambar FROM df_wisata c LEFT JOIN t_rating r ON(c.id_lokasi = r.id_lokasi) GROUP BY c.id_lokasi ORDER BY rating DESC");
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <!-- Akhir rating -->
                                <p class="card-text"><?php echo substr($d['informasi'], 0, 500)   ?>...</p>
                                <a href="?page=detail&id=<?= $d['id_lokasi'] ?> " class="btn btn-primary">Detail</a>
                            </div>
                        </div>
                    </div>
