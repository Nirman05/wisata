...
<div class="container">
        <?php
        //ambil data
        $get = $config->query("SELECT c.id_pantai AS id_pantai, nm_pantai, inf_pantai, AVG(rating) AS rating, gambar FROM pantai c LEFT JOIN p_rating r ON(c.id_pantai = r.id_pantai) GROUP BY c.id_pantai ORDER BY rating DESC");
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <!-- Akhir rating -->
                                <p class="card-text"><?php echo substr($d['inf_pantai'], 0, 200)   ?>...</p>
                                <a href="?page=detail_p&id=<?= $d['id_pantai'] ?> " class="btn btn-primary">Detail</a>
                            </div>
                        </div>
                    </div>
                </div>
